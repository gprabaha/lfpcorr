#!/bin/bash
#SBATCH --job-name=Lynch_Ephron_dmPFC_dmPFC_BLA_01082019-bla_rfft_32G
...
#SBATCH --time=1:00:00
#SBATCH --output=job_scripts/rfft_32G_Lynch_Ephron_dmPFC_dmPFC_BLA_01082019-bla.out
#SBATCH --error=job_scripts/rfft_32G_Lynch_Ephron_dmPFC_dmPFC_BLA_01082019-bla.err
