#!/bin/bash
#SBATCH --job-name=Kuro_Hitch_ACC_BLA_dmPFC_10012018-dmpfc_rfft_32G
...
#SBATCH --time=1:00:00
#SBATCH --output=job_scripts/rfft_32G_Kuro_Hitch_ACC_BLA_dmPFC_10012018-dmpfc.out
#SBATCH --error=job_scripts/rfft_32G_Kuro_Hitch_ACC_BLA_dmPFC_10012018-dmpfc.err
