#!/bin/bash
#SBATCH --job-name=Lynch_hitch_OFC_OFC_BLA_01062019-bla_rfft_week
...
#SBATCH --mem=128G
#SBATCH --time=3:00:00
#SBATCH --output=job_scripts/rfft_week_Lynch_hitch_OFC_OFC_BLA_01062019-bla.out
#SBATCH --error=job_scripts/rfft_week_Lynch_hitch_OFC_OFC_BLA_01062019-bla.err
