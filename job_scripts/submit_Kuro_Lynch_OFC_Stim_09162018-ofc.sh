#!/bin/bash
#SBATCH --job-name=Kuro_Lynch_OFC_Stim_09162018-ofc_rfft_week
...
#SBATCH --mem=128G
#SBATCH --time=3:00:00
#SBATCH --output=job_scripts/rfft_week_Kuro_Lynch_OFC_Stim_09162018-ofc.out
#SBATCH --error=job_scripts/rfft_week_Kuro_Lynch_OFC_Stim_09162018-ofc.err
