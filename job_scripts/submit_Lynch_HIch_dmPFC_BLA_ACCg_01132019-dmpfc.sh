#!/bin/bash
#SBATCH --job-name=Lynch_HIch_dmPFC_BLA_ACCg_01132019-dmpfc_rfft_32G
...
#SBATCH --time=1:00:00
#SBATCH --output=job_scripts/rfft_32G_Lynch_HIch_dmPFC_BLA_ACCg_01132019-dmpfc.out
#SBATCH --error=job_scripts/rfft_32G_Lynch_HIch_dmPFC_BLA_ACCg_01132019-dmpfc.err
