#!/bin/bash
#SBATCH --job-name=Kuro_Hitch_dmPFC_BLA_OFC_10042018-dmpfc_rfft_week
...
#SBATCH --mem=128G
#SBATCH --time=3:00:00
#SBATCH --output=job_scripts/rfft_week_Kuro_Hitch_dmPFC_BLA_OFC_10042018-dmpfc.out
#SBATCH --error=job_scripts/rfft_week_Kuro_Hitch_dmPFC_BLA_OFC_10042018-dmpfc.err
