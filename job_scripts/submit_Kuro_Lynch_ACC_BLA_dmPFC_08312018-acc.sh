#!/bin/bash
#SBATCH --job-name=Kuro_Lynch_ACC_BLA_dmPFC_08312018-acc_rfft_week
...
#SBATCH --mem=128G
#SBATCH --time=3:00:00
#SBATCH --output=job_scripts/rfft_week_Kuro_Lynch_ACC_BLA_dmPFC_08312018-acc.out
#SBATCH --error=job_scripts/rfft_week_Kuro_Lynch_ACC_BLA_dmPFC_08312018-acc.err
