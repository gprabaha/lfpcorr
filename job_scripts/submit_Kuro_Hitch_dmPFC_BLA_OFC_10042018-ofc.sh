#!/bin/bash
#SBATCH --job-name=Kuro_Hitch_dmPFC_BLA_OFC_10042018-ofc_rfft_32G
...
#SBATCH --time=1:00:00
#SBATCH --output=job_scripts/rfft_32G_Kuro_Hitch_dmPFC_BLA_OFC_10042018-ofc.out
#SBATCH --error=job_scripts/rfft_32G_Kuro_Hitch_dmPFC_BLA_OFC_10042018-ofc.err
