#!/bin/bash
#SBATCH --job-name=Kuro_Lynch_OFC_Stim_09182018-ofc_rfft_32G
...
#SBATCH --time=1:00:00
#SBATCH --output=job_scripts/rfft_32G_Kuro_Lynch_OFC_Stim_09182018-ofc.out
#SBATCH --error=job_scripts/rfft_32G_Kuro_Lynch_OFC_Stim_09182018-ofc.err
